 ...
 const router = useRouter();
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-gray-50 text-black">
      <Head>
        <title> Scriben Login</title>
        <meta name="description" content="Student login page" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <header className="bg-green-600 text-white py-5 text-center shadow-md">
        <h1 className="text-2xl font-semibold">Scribe Login</h1>
      </header>
      ...
      <main className="flex-1 flex justify-center items-center py-12 px-4">
        <div className="w-full max-w-md bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="bg-blue-800 py-4 px-6 text-white">
            ...
            <p className="text-blue-100 text-sm mt-1">Please login to access your scribe account</p>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                <label htmlFor="aadhaarNumber" className="block mb-2 font-medium text-gray-700">
                  Aadhaar Number<span className="text-green-500 ml-1">*</span>
                </label>
              ...
              <div className="mb-6">
                <label htmlFor="password" className="block mb-2 font-medium text-gray-700">
                  Password<span className="text-green-500 ml-1">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-gray-400" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
